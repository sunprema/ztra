...
| `ztra world summary <dir>` | A short picture of the lab: robot, pipettes, vials and their volumes, filled wells, tips left, sensors, and any validation problems. Good for a quick "what am I working with?". |
